...
export default function Skills() {
    ...
    const categories = {
        "languages": [{ name: "Python", years: "5 years" }, { name: "Java", years: "5 years" }, { name: "HTML/CSS", years: "4 years" }, { name: "JavaScript", years: "3 years" }, { name: "C++", years: "2 years" }, { name: "MATLAB", years: "<1 year" }],
        "tools_frameworks": [{ name: "Express.js", years: "2 years" }, { name: "Node.js", years: "2 years" }, { name: "Flask", years: "2 years" }, { name: "NumPy", years: "2 years" }, { name: "React", years: "1 year" }, { name: "OpenCV", years: "1 year" }, { name: "Next.js", years: "<1 year" }, { name: "Tailwind CSS", years: "<1 year" }]
    };
    useEffect(() => {
