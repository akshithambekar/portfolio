...
export default function Intro() {
    return (
        <div>
            <div className="flex flex-col justify-center items-center h-[620px] px-44 subpixel-antialiased text-custom_gray mx-auto max-w-[1260px]">
                ...
                <Image src="/IMG_6646.jpg" alt="My picture" width={400} height={200} className="py-12 rounded-lg"/>
            </div>
        </div>
    );
}